...
//  Bullseye
//
//  Created by Vadym Horovyi on 08/06/2020.
    ...
    var body: some View {
        Group {
            VStack {
                ...
                Text("Your goal is to place the slider as close as possible to the target value. The closer you are, the more point you score.").modifier(AboutBodyStyle()).lineLimit(nil)
                Text("Enjoy!")
            }
